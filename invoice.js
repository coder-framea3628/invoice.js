...
<footer style="display: none;">
  <img class="powered-logo" src="https://framerusercontent.com/images/QuqgHsCCdz2yoIVZLTycuuZBKo.png" alt="Powered by Frame" loading="lazy">
...
<div id="notePopup" class="popup" role="dialog" aria-modal="true">
  ...
  <button id="closeNote" data-test="close-note">Fechar</button>
</div>
...
<div id="cancelPopup" class="popup" role="dialog" aria-modal="true">
  ...
  <button id="closeCancel" data-test="close-cancel">Fechar</button>
</div>
`;
...
photoInput.onchange = e => {
  ...
  try {
    if (window.FileReader) {
      ...
      alert('Seu navegador não suporta upload de imagens. Use um navegador moderno.');
    }
  } catch (err) {
...
const cancelRenewal = document.getElementById('cancelRenewal');
const closeNote = document.getElementById('closeNote');
const closeCancel = document.getElementById('closeCancel');

requestNote.addEventListener('click', () => {
  notePopup.classList.add('active');
  closeNote.focus();
});
requestNote.addEventListener('keydown', e => { if (e.key === 'Enter') notePopup.classList.add('active'); closeNote.focus(); });

cancelRenewal.addEventListener('click', () => {
  cancelPopup.classList.add('active');
  closeCancel.focus();
});
cancelRenewal.addEventListener('keydown', e => { if (e.key === 'Enter') cancelPopup.classList.add('active'); closeCancel.focus(); });

closeNote.addEventListener('click', () => notePopup.classList.remove('active'));
closeCancel.addEventListener('click', () => cancelPopup.classList.remove('active'));