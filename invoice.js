...
<div id="overlay">
  ...
  <div id="formArea" class="fade">
    ...
    <form id="profileForm">
      ...
      <input id="email" type="email" placeholder="Insira seu e-mail" required aria-required="true">
...
const backdrops = [noteBackdrop, cancelBackdrop, detailsBackdrop, logBackdrop, infoBackdrop];
const popups = [notePopup, cancelPopup, detailsPopup, logPopup, infoPopup];
