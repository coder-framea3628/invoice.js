  ...
  <div id="formArea" class="fade">
    ...
    <form id="profileForm">
      ...
      <div id="step2" style="display:none;">
        ...
        <span id="removePhoto" style="display:none;">Remover foto</span>
...
<div id="howCancelPopup" class="popup" role="dialog" aria-modal="true">
  ...
  <p>O cancelamento interrompe renovações futuras, mas não afeta pagamentos atuais.</p>
...
const strings = {
  ...
  alertInvalidBirthDate: 'Data de nascimento inválida.',
  ...
  alertInvalidUsername: 'Username deve começar com @ e ter ao menos 3 caracteres.',
